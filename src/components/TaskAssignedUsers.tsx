...
export default function TaskAssignedUsers({ taskId, assignedUsers = [], onUpdate }: TaskAssignedUsersProps) {
 ...
 <div
 key={user.id}
 className="flex items-center justify-between p-2 rounded cursor-pointer hover:card/30 border border/30"
 ...
 <p className="text-xs text-secondary">Add users to assign them to this task</p>
 </div>
 )}
 </div>
 </div>
