...
function UserSelectorDialog({
 ...
 {/* Selection Summary */}
 <div className="flex items-center justify-between p-3 card/50 rounded-lg">
 ...
 {isLoading ? (
 <div className="text-center py-8 text-tertiary">Loading users...</div>
 ) : filteredUsers.length === 0 ? (
 <div className="text-center py-8 text-tertiary">No users found</div>
 ) : (
