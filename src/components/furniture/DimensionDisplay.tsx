...
export function DimensionDisplay({
 ...
 if (!furnitureType) {
 return (
 <Card className={`card border ${className}`}>
 <CardContent className="p-6 text-center">
 <Ruler className="h-8 w-8 text-tertiary mx-auto mb-2" />
 <p className="text-tertiary">No furniture type specified</p>
 </CardContent>
 </Card>
 );
 }
 ...
 <Label className="text-xs text-tertiary">{displayName}</Label>
 ...
 <Card className={`card border ${className}`}>
 <CardContent className="p-6 text-center">
 <Package className="h-8 w-8 text-tertiary mx-auto mb-2" />
 <p className="text-tertiary">No dimensions specified</p>
 </CardContent>
 </Card>
 );
 }
 ...
 <Ruler className="h-8 w-8 text-tertiary mx-auto mb-2" />
 <p className="text-tertiary">No dimensions have been set for this {furnitureType}</p>
 </div>
 )}
 </CardContent>
 </Card>
