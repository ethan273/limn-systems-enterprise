  ...
  if (!furnitureType) {
    return (
      <Card className={className}>
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-200">Furniture Dimensions</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            {Object.entries(dimensionGroups).map(([groupName, fields]) => (
              ...
              >
                <CollapsibleTrigger asChild>
                  <Button
                    variant="ghost"
                    className="w-full justify-between p-3 h-auto bg-gray-800/50 hover:bg-gray-700/50"
                  >
