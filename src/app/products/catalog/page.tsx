...
export default function CatalogItemsPage() {
  ...
  const filteredItems = productionReadyItems.filter((item: any) => {
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          <h1 className="page-title">Catalog Items</h1>
          <p className="page-subtitle">Production-ready items available for order</p>
        </div>
        <Button onClick={() => router.push('/products/catalog/new')}>
            ...
            {isLoading ? (
              <TableRow>
                <TableCell colSpan={8} className="text-center py-8">
                  ...
                  <p className="page-subtitle mt-2">Loading catalog items...</p>
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                <TableCell colSpan={8} className="text-center py-8">
                  <p className="page-subtitle">
                    {searchQuery ? "No catalog items found matching your search" : "No catalog items found"}
                  </p>
                  {!searchQuery && (
                    <Button
