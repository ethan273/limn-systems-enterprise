        ...
        {viewState === 'login' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sign in to collaborate on projects
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        {viewState === 'request-access' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill out this form to request partner portal access
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="bg-muted p-4 rounded-lg">
                <p className="text-sm text-center">
                  We&apos;ve received your request for partner portal access. Our team will review your
