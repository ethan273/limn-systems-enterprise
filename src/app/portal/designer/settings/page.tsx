...
/**
 * Designer Portal Settings Page
 * View designer profile and settings
 */
export default function DesignerSettingsPage() {
 ...
 router.push('/login?redirect=/portal/designer/settings');
 }
 ...
 <div>
 <h1 className="text-2xl font-bold">Designer Settings</h1>
