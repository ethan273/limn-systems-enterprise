 ...
 * Phase 4: Partner portal for designers
...
export default function DesignerPortalLayout({ children }: LayoutProps) {
  ...
  if (pathname === '/portal/designer/login' || pathname === '/portal/login') {
    return <>{children}</>;
  }
          ...
          <div className="border-t border p-4">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-secondary">Designer Portal</div>
              </div>
            </div>
            <Button
              variant="outline"
