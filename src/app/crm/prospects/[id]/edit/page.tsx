  ...
  useEffect(() => {
    if (leadData?.lead) {
      ...
      setFormData({
        ...
        prospect_status: lead.prospect_status || 'warm',
      });
    }
  }, [leadData]);
      ...
      <div className="page-container">
        <div className="flex flex-col items-center justify-center py-12 space-y-4">
          ...
          <div className="text-center space-y-2">
            <h3 className="text-lg font-semibold">Failed to load prospect</h3>
            <p className="text-sm text-muted-foreground max-w-md">
              {queryError.message || 'An error occurred while loading the prospect.'}
            </p>
          </div>
          <Button
            onClick={() => utils.crm.leads.getById.invalidate({ id: prospectId })}
            variant="outline"
            className="gap-2"
          >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <SelectTrigger id="prospect_status" className="pl-10">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
