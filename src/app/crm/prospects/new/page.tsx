...
export default function NewProspectPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    prospect_status: 'warm', // Default to warm for new prospects
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create as a lead with prospect_status set (which makes it a prospect)
    createLead.mutate({
      ...
      prospect_status: formData.prospect_status, // This is what makes it a prospect
      tags: [],
    });
  };
    ...
    <div className="page-container">
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          ...
          {/* Step 3: Prospect-Specific Information */}
          {selectedContact && (
            <Card>
              <CardHeader>
                <CardTitle>Step 3: Prospect Details</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Flame className="absolute left-3 top-3 h-4 w-4 text-muted-foreground z-10" />
                      <Select
                        value={formData.prospect_status}
                        onValueChange={(value) => handleChange('prospect_status', value)}
                      >
                        <SelectTrigger id="prospect_status" className="pl-12">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Temperature indicator for prospect qualification
                    </p>
                  </div>
