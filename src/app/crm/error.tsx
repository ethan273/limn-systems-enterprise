...
export default function CRMError({
 ...
 useEffect(() => {
 log.error('[CRM Module Error]:', error);
 }, [error]);
 ...
 Something went wrong in CRM
 </h2>

 <p className="text-secondary mb-6">
 An error occurred while loading the CRM module. This has been logged and we&apos;re working on it.
 </p>
 ...
 {error.digest && (
 <p className="mt-6 text-xs text-tertiary">Error ID: {error.digest}</p>
 )}
 </div>
 </div>
 );
