  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          <h1 className="page-title">Production Shipments</h1>
          <p className="page-description">
            Prepare and track shipments from production orders
          </p>
        </div>
        <Button
      ...
      {isLoading ? (
            ...
            <div className="empty-state">
              ...
              <p className="empty-state-description">
                No shipments match your current filters. Production shipments will appear here.
              </p>
            </div>
          ) : (
              ...
              <Table>
                ...
                <TableBody>
                  {shipments.map((shipment) => {
                    ...
                    const packagesArray = Array.isArray(shipment.packages)
                      ? shipment.packages
                      : [];
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          ...
                          >
                            {statusInfo?.icon}
                            <span>{statusInfo?.label || shipment.status}</span>
                          </Badge>
                        </TableCell>
                        <TableCell>
                          <Badge variant="outline" className="badge-neutral">
