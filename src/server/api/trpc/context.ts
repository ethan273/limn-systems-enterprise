 ...
 */
const passThrough = <T extends (..._args: any[]) => any>(fn: T): T => fn;

let cacheWrapper: <T extends (..._args: any[]) => any>(_fn: T) => T = passThrough;
...
if (typeof require !== 'undefined') {
  try {
    ...
    // React not available - use pass-through (already set)
  }
}
